...
/**
 * Sticky "on this page" side menu. Highlights the section currently in view
 * and scrolls to it on click. On small screens it collapses into a
 * horizontally scrolling strip that sticks under the header.
 *
 * Generic version of AboutNav — pass whatever sections the page renders.
 */
