...
export const nav: NavItem[] = [
  ...
  { label: "Hall Booking", href: "/resources/book-hall" },
...
/** Past event photo arrays. Files live in /public/assets/past events and are
    grouped by event name so they can appear in a gallery-style sidebar layout. */
const P = (folder: string, file: string) =>
  `/assets/past%20events/${encodeURIComponent(folder)}/${encodeURIComponent(file)}`;

export const pastEventAlbums = [
  {
    id: "contract-management",
    title: "CONTRACT MANAGEMENT",
    meta: "Past event gallery",
    blurb: "Snapshots from the Contract Management event and related proceedings.",
    photos: [
      { src: P("CONTRACT MANAGEMENT", "1.jpeg") },
      { src: P("CONTRACT MANAGEMENT", "2.JPG") },
      { src: P("CONTRACT MANAGEMENT", "3.JPG") },
      { src: P("CONTRACT MANAGEMENT", "4.JPG") },
    ],
  },
  {
    id: "techknow-2010",
    title: "TECHKNOW 2010",
    meta: "Past event gallery",
    blurb: "Images from the TECHKNOW 2010 convention and programme sessions.",
    photos: [
      { src: P("TECHKNOW 2010", "1.JPG") },
      { src: P("TECHKNOW 2010", "2.JPG") },
      { src: P("TECHKNOW 2010", "3.JPG") },
      { src: P("TECHKNOW 2010", "4.JPG") },
    ],
  },
  {
    id: "techknow-2011",
    title: "TECHKNOW 2011",
    meta: "Past event gallery",
    blurb: "Highlights from TECHKNOW 2011, including sessions and participant moments.",
    photos: [
      { src: P("TECHKNOW 2011", "1.JPG") },
      { src: P("TECHKNOW 2011", "2.JPG") },
      { src: P("TECHKNOW 2011", "3.JPG") },
      { src: P("TECHKNOW 2011", "4.JPG") },
    ],
  },
  {
    id: "techknow-2022",
    title: "TECHKNOW 2022",
    meta: "Past event gallery",
    blurb: "A showcase of the TECHKNOW 2022 event experiences across key programme moments.",
    photos: [
      { src: P("TECHKNOW 2022", "1.jpg") },
      { src: P("TECHKNOW 2022", "2.jpg") },
      { src: P("TECHKNOW 2022", "3.jpg") },
      { src: P("TECHKNOW 2022", "4.jpg") },
      { src: P("TECHKNOW 2022", "5.jpg") },
    ],
  },
];
...
export const venues = [
  {
    ...
    area: "1,000 sq ft",
    image: img.aimoHall,
    rates: "Members ₹ 400 / hour · Non-members ₹ 500 / hour (minimum rent per hour)",
    features: [
